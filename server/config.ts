...
export const serverConfig = {
  ...
  postgresTestDatabaseUrl: process.env.POSTGRES_TEST_DATABASE_URL?.trim() || '',
  postgresPoolMax: readNumberEnv('POSTGRES_POOL_MAX', 10),
  postgresIdleTimeoutMs: readNumberEnv('POSTGRES_IDLE_TIMEOUT_MS', 30000),
  postgresConnectionTimeoutMs: readNumberEnv('POSTGRES_CONNECTION_TIMEOUT_MS', 5000),
