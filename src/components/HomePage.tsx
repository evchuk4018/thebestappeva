...
export default function HomePage() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 items-center justify-center h-full w-full bg-zinc-950 p-6 gap-6 select-none overflow-y-auto place-items-center">
      <motion.button
